...
GO_DEPENDENCIES=github.com/golang-collections/go-datastructures
...
setGlobals() {
  ...
  if [ $ORG -eq 1 ]; then
    ...
    CORE_PEER_ADDRESS=peer0.org4.example.com:7351
  elif [ $ORG -eq 5 ]; then
    ...
    CORE_PEER_ADDRESS=peer0.org6.example.com:7551
  elif [ $ORG -eq 7 ]; then
    ...
    CORE_PEER_ADDRESS=peer0.org7.example.com:7651
  elif [ $ORG -eq 8 ]; then
    ...
    CORE_PEER_ADDRESS=peer0.org8.example.com:7751
  elif [ $ORG -eq 9 ]; then
    ...
    CORE_PEER_ADDRESS=peer0.org9.example.com:7851
  elif [ $ORG -eq 10 ]; then
    ...
    CORE_PEER_ADDRESS=peer0.org10.example.com:7951
  else
...
chaincodeInvoke() {
  ...
  if [ "${IS_INIT}" -eq "1" ]; then
    CCARGS='{"Args":["Init","Org1","1000","Org2","100","Org3","1000","Org4","1000","Org5","1000","Org6","1000","Org7","1000","Org8","1000","Org9","1000","Org10","1000"]}'
    INIT_ARG="--isInit"
  else
