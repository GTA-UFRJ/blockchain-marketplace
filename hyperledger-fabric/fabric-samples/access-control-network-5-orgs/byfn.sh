...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    rm -rf channel-artifacts/*.block channel-artifacts/*.tx crypto-config ./org5-artifacts/crypto-config/ channel-artifacts/org5.json
  fi
}
...
COMPOSE_FILE_ORG3=docker-compose-org4.yaml
COMPOSE_FILE_ORG3=docker-compose-org5.yaml
