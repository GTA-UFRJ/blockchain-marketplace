...
do
    ...
    do
        ...
        scp -r crypto-config gta@ipanema:~gta/gustavo/secTry/access-control-network >> /dev/null 2>&1
        scp -r channel-artifacts gta@ipanema:~gta/gustavo/secTry/access-control-network >> /dev/null 2>&1
        scp -r crypto-config gta@praiavermelha:~gta/gustavo/secTry/access-control-network >> /dev/null 2>&1
        scp -r channel-artifacts gta@praiavermelha:~gta/gustavo/secTry/access-control-network >> /dev/null 2>&1
