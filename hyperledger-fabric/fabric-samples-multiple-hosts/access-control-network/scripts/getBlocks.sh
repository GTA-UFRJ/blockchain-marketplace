...
function getBlock() {
    ...
    docker cp cli:/opt/gopath/src/github.com/hyperledger/fabric/peer/newestblock-${clients}clients-${round}round_read.block ~gta/gustavo/secTry/access-control-network/scripts/results/blocks &
    docker cp cli:/opt/gopath/src/github.com/hyperledger/fabric/peer/7block-${clients}clients-${round}round_read.block ~gta/gustavo/secTry/access-control-network/scripts/results/blocks &
