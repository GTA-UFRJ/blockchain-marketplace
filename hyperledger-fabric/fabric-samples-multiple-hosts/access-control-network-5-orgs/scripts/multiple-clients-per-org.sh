...
function issueTransaction() {
    ...
    done ; } 2>> /opt/gopath/src/github.com/hyperledger/fabric/peer/scripts/results/multiple-clients-per-org/"$clients"clients-per-org-"$transaction"tx-round"$round".txt  
